...
void changetored() {
  valor=0xEF00;//mudar para valor certo
   ...
   Serial.println(tipo); 
  server.send(200, "text/html", vermelho);
}
...
void changetogreen() {
   ...
   tipo=res.decode_type;
   Serial.println(tipo); 
  server.send(200, "text/html", verde);
}
...
void changetoblue() {
  valor=0xF7609F;
   ...
   tipo=res.decode_type;
   Serial.println(tipo); 
  server.send(200, "text/html", azul);
}
...
void changetoamarelo() {
   ...
   tipo=res.decode_type;
   Serial.println(tipo); 
  server.send(200, "text/html", amarelo);
}
...
void changetopurple() {
  valor=0xF748B7;
   ...
   tipo=res.decode_type;
   Serial.println(tipo); 
  server.send(200, "text/html", roxo);
}
...
void changetodarkpurple() {
   ...
   tipo=res.decode_type;
   Serial.println(tipo); 
  server.send(200, "text/html", rochao);
}
...
void changetowhite() {
   ...
   tipo=res.decode_type;
   Serial.println(tipo); 
  server.send(200, "text/html", branco);
}
...
void changetoorange() {
   ...
   tipo=res.decode_type;
   Serial.println(tipo); 
  server.send(200, "text/html", laranja);
}
...
void changetopink() {
   ...
   tipo=res.decode_type;
   Serial.println(tipo); 
  server.send(200, "text/html", rosa);
}
...
void changetowatergrenn() {
   ...
   tipo=res.decode_type;
   Serial.println(tipo); 
  server.send(200, "text/html", verdin);
}
